...
public class RecordServiceImp implements RecordService {
	...
	public Integer createNewCaseEvent(JSONObject jsonData) throws JSONException {
		...
		courtObj.setCourtId(Integer.parseInt((EviProperty.evidencerProperty.getProperty("defaultCourtId"))));
	...
	@Override
	public void updateDb(String caseNo,int caseEventId, JSONObject jsonData) throws JSONException {
