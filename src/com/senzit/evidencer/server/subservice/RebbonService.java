...
public class RebbonService {
	...
	public String requestToRebbon(String postData){
		...
		String rebbonUrl=EviProperty.evidencerProperty.getProperty("rebbonUrl");
		////////////////////////////////////////////////////
		...
		try {
			...
			connection.setConnectTimeout(Integer.parseInt(EviProperty.evidencerProperty.getProperty("rebbonTimeout")));
